...
def get_parser():
    ...
    parser.add_argument("--output_dir", type=str, default="results/models/X_101_smallobj")
    parser.add_argument("--trained_model", type=str, default="checkpoints/models/X_101_dice_90")
...
def setup_model(args):
    cfg = get_cfg()
    base_cfg_path = model_zoo.get_config_file("COCO-InstanceSegmentation/mask_rcnn_X_101_32x8d_FPN_3x.yaml")
    ...
    # print("Available MODEL.RPN keys:", cfg.MODEL.RPN)
    cfg.MODEL.ROI_HEADS.SCORE_THRESH_TEST = 0.5
    cfg.MODEL.DEVICE = args.device
    cfg.DETECTION_MAX_INSTANCES = 1000
    cfg.DETECTIONS_PER_IMAGE = 1000 
